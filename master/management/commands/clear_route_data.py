...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # CustodyCustom.objects.filter(customer__routes__route_name="v1").delete()
        # Vacation.objects.filter(customer__routes__route_name="v1").delete()
        # DiffBottlesModel.objects.filter(customer__routes__route_name="v1").delete()
        # OtherRequirementModel.objects.filter(customer__routes__route_name="v1").delete()
        # CouponPurchaseModel.objects.filter(customer__routes__route_name="v1").delete()
        # CustodyPullOutModel.objects.filter(customer__routes__route_name="v1").delete()
        # CustomerComplaint.objects.filter(customer__routes__route_name="v1").delete()
        # Customer_Order.objects.filter(customer_id__routes__route_name="v1").delete()
        # ChangeOrReturn.objects.filter(customer__routes__route_name="v1").delete()
        # SaleEntryLog.objects.filter(customer__routes__route_name="v1").delete()
        # OutstandingLog.objects.filter(customer__routes__route_name="v1").delete()
        # Transaction.objects.filter(customer__routes__route_name="v1").delete()
        # CustomerCoupons.objects.filter(customer__routes__route_name="v1").delete()
        # Transactionn.objects.filter(customer__routes__route_name="v1").delete()
        CollectionPayment.objects.filter(customer__routes__route_name="v1").delete()
        # SalesmanSpendingLog.objects.filter(customer__routes__route_name="v1").delete()
